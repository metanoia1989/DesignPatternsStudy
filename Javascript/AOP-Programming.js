...
这些业务逻辑无关的功能通常包括日志统计、安全控制、异常处理等。
...
// 利用 prototype 为 Function 动态添加 before 和 after 函数
...
// =_= 为什么会执行 after 和 before 看不懂诶
// 使用 AOP的方式来给函数添加职责，也是 JavaScript语言中一种非常特别和巧妙的装饰者模式实现。
